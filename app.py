...
st.caption(
    "v1.0.2 Settings Hotfix · Intelligence Center · Match Report · JOYA Explain · Heatmap · Top 2"
)
...
settings.setdefault("max_per_league", 2)
...
c3.metric("Familias activas", len(settings["selected_groups"]))
